...
/**
 * ViewPoi generated by hbm2java
 */
@Entity
@Table(name = "View_POI", schema = "dbo", catalog = "FMS4.0")
public class ViewPoi implements java.io.Serializable {

	private ViewPoiId id;

	public ViewPoi() {
	}

	public ViewPoi(ViewPoiId id) {
		this.id = id;
	}
	...
	public ViewPoiId getId() {
		return this.id;
	}

	public void setId(ViewPoiId id) {
		this.id = id;
	}
