...
/**
 * UsersDeleteHistory generated by hbm2java
 */
@Entity
@Table(name = "Users_DeleteHistory", schema = "dbo", catalog = "FMS4.0", uniqueConstraints = @UniqueConstraint(columnNames = {
		"LoginID", "id" }))
public class UsersDeleteHistory implements java.io.Serializable {
	...
	public UsersDeleteHistory() {
	}

	public UsersDeleteHistory(int id, Serializable loginId, Serializable password) {
		this.id = id;
		this.loginId = loginId;
		this.password = password;
	}

	public UsersDeleteHistory(int id, Integer companyId, Serializable loginId, Serializable password,
			Serializable firstName, Serializable lastName, Serializable email, Serializable phone, Serializable mobile,
			Boolean isActive, Serializable createdBy, Date createOn, Serializable modifiedBy, Date modifiedOn,
			Boolean isDeleted, Boolean isMobileUser) {
		this.id = id;
