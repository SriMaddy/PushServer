...
/**
 * VehicleDriverAssociaton generated by hbm2java
 */
@Entity
@Table(name = "VehicleDriverAssociaton", schema = "dbo", catalog = "FMS4.0")
public class VehicleDriverAssociaton implements java.io.Serializable {
	...
	public VehicleDriverAssociaton() {
	}

	public VehicleDriverAssociaton(int id, int vehicleId, int driverId, Date fromdate, Date todate, boolean isDeleted) {
		this.id = id;
