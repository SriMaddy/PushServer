...
/**
 * TblTripRouteShedule generated by hbm2java
 */
@Entity
@Table(name = "tblTripRouteShedule", schema = "dbo", catalog = "FMS4.0")
public class TblTripRouteShedule implements java.io.Serializable {
	...
	public TblTripRouteShedule() {
	}

	public TblTripRouteShedule(int id, int routeId, int sheduleId) {
		this.id = id;
		this.routeId = routeId;
		this.sheduleId = sheduleId;
	}

	public TblTripRouteShedule(int id, int routeId, int sheduleId, Boolean isdeleted, Serializable createdBy,
			Date createdOn, Serializable tripId) {
		this.id = id;
		this.routeId = routeId;
		this.sheduleId = sheduleId;
